...
ws = Tk()
ws.title('iBanking Welcomes You')
ws.geometry('995x600')
ws.config(bg='#0B5A81')
...
def insert_record():
    ...
    if check_counter == 7:
        try:
            con = sqlite3.connect('bms_py.db')
            cur = con.cursor()
            cur.execute("INSERT INTO register VALUES (:name, :email, :contact, :gender, :password)", {
...
#img = PhotoImage(
   #file='C:/Users/A3HISH3K/Documents/MCA Sem 2 Project/images/registration.png')
